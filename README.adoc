...
1. Fist step to add repository secrets:
...
2. To create publish script in the github action, please add the publish.yml file in the .github/workflows
...
3. Change and update the version variable in the build.gradle file. If you do not update version, there will be failed for releaseSonatypeStagingRepository, because version confilicate with the package have been released.
